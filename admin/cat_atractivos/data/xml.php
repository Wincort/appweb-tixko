...
$sql="SELECT * FROM cat_atractivos";
...
while($row = mysql_fetch_array($result)){
	...
	$temp=$row['publicar'];
	if($temp!=''){
	print('<cell name="img"><![CDATA[<a href="#"><input type="image" src="multimedia/imagen/'.html_entity_decode($row['imagen']).'" style="width:30%; height:auto" align="center alt="img"></a>]]></cell>');
