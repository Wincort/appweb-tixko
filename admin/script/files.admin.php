<?php
	function uploadFiles($file){
		...
		if($nombre_archivo != ""){
			...
			echo "<br><br>";
			print_r($ruta_files.$nombre_archivo);
			echo "<br><br>";*/
			//se añadio utf8_decode para guardar correctamente los nombres de los archivos
			//if (move_uploaded_file($file['tmp_name'], $ruta_files.utf8_decode ($nombre_archivo))){
			if (move_uploaded_file($file['tmp_name'], $ruta_files.utf8_decode ($nombre_archivo))){
				$ltranx = true;
			}
		}
