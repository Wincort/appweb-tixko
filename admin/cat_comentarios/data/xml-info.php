...
$sql="SELECT * FROM cat_comentarios where id=".$id." LIMIT 1";
...
while($row = mysql_fetch_array($result)){
	...
	print("</row>");	
	print("<row id='mensaje'>");
	print("<cell><![CDATA[Mensaje]]></cell>");
	print("<cell><![CDATA[".html_entity_decode(utf8_decode($row['mensaje']))."]]></cell>");
	print("</row>");
