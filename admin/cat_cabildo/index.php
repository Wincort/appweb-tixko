...
<head>
    ...
    <script type="text/javascript">
        ...
        dhtmlxEvent(window,"load",function(){                                         
            ...
            masterGrid.setHeader("Nombre,Puesto");                           
            masterGrid.setColumnIds("nombre,puesto");                         
            masterGrid.setInitWidthsP("50,50");                                
            masterGrid.setColAlign("left,left,center");                            
			...
			masterGrid.attachEvent("onRowSelect",function(id){
				progressOn(false);
				myCellB.attachURL("cabildo.subir.archivo.php?opc=UPD&tipo=IMAGEN&id="+id);
                myCellB.expand();
                //myCellA.collapse();
			});
			masterGrid.setSkin("dhx_web");
            masterGrid.init();                                                    
            masterGrid.load("data/cabildo.xml.php");

			
            var dpg = new dataProcessor("data/cabildo.datos.php");                          //inits dataProcessor
		...
		function recargarGrid(){
			masterGrid.clearAndLoad("data/cabildo.xml.php");
		}
