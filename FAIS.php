...
<head>
	...
	<link rel="stylesheet" href="css/FAIS.css">
...
<div class="container">
	<div class="rows">
		...
		<div class="col-sm-8">
			<img src="images/LOGO FAIS.jpg" class="img-responsive" alt="Image">
		</div>
		<div class="col-sm-2"></div>
	</div>
	<div class="rows">
...
<script type="text/javascript">
	...
	var ar = <?php echo json_encode($ListaFAIS) ?>;
	...
	let GenerarEnlaces = (IdRegistro,Directorio) => {
		TraerElementoFAIS(IdRegistro,Directorio)
			.then(data => {
				for(let i in data){
	...
	let TraerElementoFAIS = async(IdRegistro) => {
